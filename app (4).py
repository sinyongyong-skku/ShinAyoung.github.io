...
.hero-title{font-family:'DM Serif Display',serif;font-size:34px;color:#2C3A1E!important;line-height:1.25;margin-bottom:8px;}
.hero-eye{font-size:11px;font-weight:500;letter-spacing:.1em;color:#4A7C3F!important;margin-bottom:8px;}
.hero-sub{font-size:14px;color:#5A6A50!important;line-height:1.65;}
.hero *{color:#2C3A1E!important;}
.hero .hero-eye{color:#4A7C3F!important;}
.hero .hero-sub{color:#5A6A50!important;}
...
with tab1:
    ...
    <div class="hero">
        ...
        <h1 class="hero-title" style="color:#2C3A1E!important;font-family:'DM Serif Display',serif;">오늘의 식재료를<br>탐색해보세요</h1>
        <p class="hero-sub" style="color:#5A6A50!important;">22가지 식재료 수록 — 아래 추천 6가지를 살펴보거나,<br>검색창에 이름을 입력해 원하는 식재료를 찾아보세요</p>
    </div>""", unsafe_allow_html=True)
